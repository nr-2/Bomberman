bomberman-dom
Multiplayer Bomberman game with real-time chat using WebSockets.
...
3. **Start the game server (Terminal 2):**
   ```bash
   npm run serve
   ```

4. **Open the game:**
   - Go to `http://localhost:8080/public/index.html` in your browser
